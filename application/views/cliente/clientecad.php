                        ...
                        <form id="ClienteForm" action="<?php if($edita != null){ echo base_url('cliente/updateCliente'); }else{ echo base_url('cliente/insertCliente'); } ?>" method="post" enctype='multipart/form-data'>
                                ...
                                <div class="col-md-12" style="background-color:white; border-radius: 5px">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <a class="btn btn-primary" href="<?php echo base_url('clientes') ?>"><i class="fas fa-backward"></i>&nbsp;Voltar</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input id="cnpj" name="cnpj" type="text" class="form-control" placeholder="000.000.000-00" required <?php if($edita != null){echo "value='".$edita['cliente_cpfcnpj']."' disabled";} ?>>
                                    ...
                                    <div class="row xdiv">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input id="nome" name="nome" type="text" class="form-control x" placeholder="Nome" disabled <?php if($edita != null){echo "value='" . $edita['cliente_nome'] . "'";} ?>>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Registro Geral (RG)</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input id="rg" name="rg" type="text" class="form-control x" placeholder="Registro Geral (RG)" disabled <?php if($edita != null){echo "value='" . $edita['cliente_rg'] . "'";} ?>>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Data de Nascimento</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input id="nascimento" name="nascimento" type="date" class="form-control x" placeholder="Data de Nascimento" disabled <?php if($edita != null){echo "value='" . $edita['cliente_nascimento'] . "'";} ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row xdiv">
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input id="razao" name="razao" type="text" class="form-control x" placeholder="Razão Social" disabled <?php if($edita != null){echo "value='" . $edita['cliente_razao'] . "'";} ?>>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Nome Fantasia</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input id="fantasia" name="fantasia" type="text" class="form-control x" placeholder="Nome Fantasia" disabled <?php if($edita != null){echo "value='" . $edita['cliente_fantasia'] . "'";} ?>>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Ramo de Atividade</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input id="ramo" name="ramo" type="text" class="form-control x" placeholder="Ramo de Atividade" disabled <?php if($edita != null){echo "value='" . $edita['cliente_ramo'] . "'";} ?>>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Inscrição Estadual</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input id="ie" name="ie" type="text" class="form-control x" placeholder="Inscrição Estadual" disabled <?php if($edita != null){echo "value='" . $edita['cliente_ie'] . "'";} ?>>
                                        </div>
                                    </div>
                                    
                                    <div class="row xdiv">
                                        <div class="col-md-8">
                                            <label>Nome do Contato</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input id="nome_r" name="nome_r" type="text" class="form-control x" placeholder="Nome do Contato" disabled <?php if($edita != null){echo "value='" . $edita['cliente_cont'] . "'";}?>>
                                        </div>
                                        <div class="col-md-4">
                                            <label>Telefone do Contato</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input id="tel_r" name="tel_r" type="text" class="form-control x" placeholder="(00) 00000-0000" disabled <?php if($edita != null){echo "value='" . $edita['cliente_telcont'] . "'";}?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row xdiv">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input id="cidade" name="cidade" type="text" class="form-control x" placeholder="Cidade" required readonly disabled <?php if($edita != null){echo "value='".$edita['cliente_cidade']."'";} ?>>
                                        </div>
                                        <div class="col-md-2 form-group">
                                            <label>Estado</label><br>
                                            <input id="estado" name="estado" type="text" class="form-control x" placeholder="Estado" required readonly disabled <?php if($edita != null){echo "value='".$edita['cliente_estado']."'";} ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row xdiv">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input id="tel" name="tel" type="text" class="form-control x" placeholder="(00) 0000-0000" disabled <?php if($edita != null){echo "value='".$edita['cliente_fixo']."'";} ?>>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>Celular 1</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input id="cel1" name="cel1" type="text" class="form-control x" placeholder="(00) 00000-0000" disabled <?php if($edita != null){echo "value='".$edita['cliente_cel1']."'";} ?>>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>Celular 2</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input id="cel2" name="cel2" type="text" class="form-control x" placeholder="(00) 00000-0000" disabled <?php if($edita != null){echo "value='".$edita['cliente_cel1']."'";} ?>>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" id="docs-div">
                                        <div id="docs-column-1" class="col-md-6 text-center active-doc fixed-doc">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <?php if($edita != null){ if($fixed != null && $fixed['documento_isimagem'] == 0){ echo "<a target='_blank' title='Clique para visualizar!' href='".base_url('uploads/').$edita['cliente_cpfcnpj']."_5.pdf'>"; } } ?>
                                                    <img src="<?php  if($edita != null){
                                                        if($fixed != null && $fixed['documento_isimagem'] == 1){
                                                            echo base_url('uploads/' . $edita['cliente_cpfcnpj'] . '_5.png');
                            ...
                            <div class="row white-tab" id="divPag" style="display: none;">
                                <div class="col-md-12" style="background-color:white; border-radius: 5px">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            <label>CPF / CNPJ do Titular</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input type="text" class="form-control" name="titular_cpfcnpj" id="titular_cpfcnpj" placeholder="CPF / CNPJ" <?php if($edita != null){echo "value='" . $edita['cliente_tit_cpfcnpj'] . "'";} ?>>
                                        </div>
                                        <div class="col-md-8 form-group">
                                            <label>Nome do Titular</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input type="text" class="form-control" name="titular_nome" id="titular_nome" placeholder="Nome" <?php if($edita != null){echo "value='" . $edita['cliente_tit_nome'] . "'";} ?>>
                                        </div>
                                        
                                        <div class="col-md-4 form-group">
                                            <label>Banco</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input type="text" class="form-control" name="banco" id="banco" placeholder="Banco" <?php if($edita != null){echo "value='" . $edita['cliente_banco'] . "'";} ?>>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Agência</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input type="text" class="form-control" maxlength="10" name="agencia" id="agencia" placeholder="Agência" <?php if($edita != null){echo "value='" . $edita['cliente_agencia'] . "'";} ?>>
                                        </div>
                                        <div class="col-md-1 form-group">
                                            <label>Dig.</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input type="text" class="form-control" maxlength="2" name="agencia_d" id="agencia_d" placeholder="Dígito" <?php if($edita != null){echo "value='" . $edita['cliente_agencia_d'] . "'";} ?>>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Conta</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input type="text" class="form-control" maxlength="10" name="conta" id="conta" placeholder="Conta" <?php if($edita != null){echo "value='" . $edita['cliente_conta'] . "'";} ?>>
                                        </div>
                                        <div class="col-md-1 form-group">
                                            <label>Dig.</label><label style="color: #c90000">&nbsp;&nbsp;**</label><br>
                                            <input type="text" class="form-control" maxlength="2" name="conta_d" id="conta_d" placeholder="Dígito" <?php if($edita != null){echo "value='" . $edita['cliente_conta_d'] . "'";} ?>>
                                        </div>
                                    </div>
                            ...
                            <div class="row xdiv">
                                <div class="col-md-12 text-center">
                                    <a href="<?php echo base_url('clientes') ?>" class="btn btn-danger">&nbsp&nbspCancelar&nbsp&nbsp</a>
                                    &nbsp&nbsp&nbsp&nbsp
            ...
            <script>
                $(document).ready(function(){
                    ...
                    $('#cel1').mask(SPMaskBehavior, spOptions);
                    $('#cel2').mask(SPMaskBehavior, spOptions);
                        ...
                        $.ajax({
                            ...
                            success : function(res) {
                                if(res != null){
                                    ...
                                    $('#cel1').val(res.cliente_cel1);
                                    $('#cel2').val(res.cliente_cel2);
