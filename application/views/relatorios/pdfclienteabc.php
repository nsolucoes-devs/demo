    ...
    <div class="col-md-12" id="main" style="padding: 20px 40px">
        ...
        <div class="row">
            <div class="col-md-12 form-group text-center">
                ...
                <br><br>
                <h3 style="font-weight: bold">Clientes ABC - <?php date_default_timezone_set('America/Sao_Paulo'); echo date('d/m/Y') ?></h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 form-group">
                <div>
                    <h4 style="padding-top: 20px"><b>CLIENTES ABC:</b></h4>
                </div>
        ...
        <footer id="footer" style="position: fixed; bottom: 0; text-align: center; width: 100%; margin-bottom: -30px; display: none">
            <div class="row">
                <div class="col-md-5 text-left">
                    <p><b>Clientes ABC | <?php echo date('d/m/Y - H:i:s') ?></b></p>
                </div>
