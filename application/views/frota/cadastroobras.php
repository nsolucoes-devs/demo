                        ...
                        <form action="<?php echo base_url('frota/insertFrota') ?>" method="post" enctype='multipart/form-data'>
                            ...
                            <div id="divDados" class="change-tab-div white-tab">
                                <div class="col-md-12" style="background-color:white; border-radius: 5px">
                                    ...
                                    <input type="hidden" id="id" name="id" <?php if($edita != null){echo "value='". $edita['obra_id'] ."'";} ?>/>
                                    
                                    <div class="row">
                                        
                                        <div class="col-md-6 form-group">
                                            <label for="nome">No</label><br>
                                            <input id="nome" name="nome" type="text" class="form-control" maxlength="30" <?php if($edita != null){echo "value='". $edita['obra_nome'] ."'";} ?> placeholder="Nome da Obra"/>
                                        </div>
                                        
                                        <div class="col-md-3 form-group">
                                            <label for="cidade">Cidade</label><br>
                                            <input id="cidade" name="cidade" type="text" class="form-control" maxlength="30" <?php if($edita != null){echo "value='". $edita['obra_cidade'] ."'";} ?> placeholder=""/>
                                        </div>
                                        
                                        <div class="col-md-3 form-group">
                                            <label for="estado">Estado</label><br>
                                            <input id="estado" name="estado" type="text" class="form-control" maxlength="20" <?php if($edita != null){echo "value='". $edita['obra_estado'] ."'";} ?> placeholder=""/>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            <label for="clienteobra">Cliente da Obra</label><br>
                                            <div style="width: 80%; display: inline; float: left;">
                                                <select class="js-example-basic-multiple form-control"  style="width: 100%!important" name="clienteobra" id="clienteobra" required>
                                                    <option selected disabled>-- Selecionar --</option>
                                                     <?php foreach($tiposgabine as $tipogabine)
                                                         if($tipogabine['frota_tipogabine_suplemento'] != "1")?>
                                                         <option value="<?php echo $tipogabine['obra_cliente'] ?>" <?php if($tipogabine['obra_cliente'] == $edita['obra_cliente']){echo "selected";} ?>><?php echo $tipogabine['obra_cliente'] ?></option>
                                                     <?php  ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-5 form-group" style="display:<?php if($edita['obra_tipo']){echo "display;";}else{ echo "none";} ?>">
                                            <label for="tipoobra">Tipo de Obra</label><br>
                                            <div style="width: 75%; display: inline; float: left;">
                                                <select class="js-example-basic-multiple"  style="width: 100%!important" name="tipoobra" id="tipoobra" required>
                                                    <option selected disabled>-- Selecionar --</option>
                                                    <?php foreach($tiposmunck as $tipomunck){ ?>
                                                        <option value="<?php echo $tipomunck['obra_tipo'] ?>" <?php if($tipomunck['obra_tipo'] == $edita['obra_tipo']){echo "selected";} ?>><?php echo $tipomunck['obra_tipo'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <select class="js-example-basic-multiple form-control"  style="width: 100%!important" name="responsavel" id="responsavel" required>
                                                <option selected disabled>-- Selecionar --</option>
                                                <?php foreach($linhas as $linha){ ?>
                                                    <option value="<?php echo $linha['obra_responsavel'] ?>" <?php if($linha['obra_responsavel'] == $edita['obra_responsavel']){echo "selected";} ?>><?php echo $linha['obra_nome'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" class="form-control" name="engenheiro" id="engenheiro" placeholder="Ex.: 3" <?php if($edita != null){echo "value='". $edita['obra_engenheiro'] ."'";} ?>>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input id="gestor" name="gestor" type="text" class="form-control" <?php if($edita != null){echo "value='". $edita['obra_gestor'] ."'";} ?> onkeypress="$(this).mask('0000/0000');" placeholder="Ex.: 1998/1999" required />
                                        </div>
                                        
                                        <div class="col-md-6 form-group">
                                            <label for="gestorempresa">Gestor do Contrato Empresa</label><br>
                                            <input id="gestorempresa" name="gestorempresa" type="text" <?php if($edita != null){echo "value='". $edita['obra_gestor_empresa'] ."'";} ?> class="form-control" placeholder="Ex.: Dourado" />
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input <?php if($edita != null){echo "value='". $edita['obra_data_inicial'] ."'";} ?> id="datainicial" name="datainicial" type="text" class="form-control" placeholder="0" />
                                        </div>
                                        
                                        <div class="col-md-3 form-group">
                                            <label for="datafinal">Data Final</label><br>
                                            <input <?php if($edita != null){echo "value='". $edita['obra_data_final'] ."'";} ?> id="datafinal" name="datafinal" type="text" class="form-control peso" placeholder="0" />
                                        </div>
                                        
                                        <div class="col-md-3 form-group">
                                            <label>Valor da Obra</label><br>
                                            <input <?php if($edita != null){echo "value='". $edita['obra_valor'] ."'";} ?> id="valorobra" name="valorobra" type="text" class="form-control peso" placeholder="0">
                                        </div>
                                        
                                        <div class="col-md-3 form-group">
                                            <label>Número do Contrato</label><br>
                                            <input <?php if($edita != null){echo "value='". $edita['obra_numero_contrato'] ."'";} ?> id="numero" name="numero" type="text" class="form-control peso" placeholder="0">
                                        </div>
                                    ...
                                    <div class="row" <?php if($edita == null){ echo "style='display:none;'"; } ?>>
                                        ...
                                        <div class="col-md-4 form-group">
                                            <label>Relatório de Custo de Obra</label><br>
                                            <input <?php if($edita != null){echo "value='". $edita['obra_relatorio'] ."'";} ?> id="relatorio" name="relatorio" type="text" class="form-control peso" placeholder="0">
                                        </div>
                                        
                                        <div class="col-md-4 form-group">
                                            <label>Calculando Valor Inicial</label><br>
                                            <input <?php if($edita != null){echo "value='". $edita['obra_calcular_valor'] ."'";} ?> id="calculo" name="calculo" type="text" class="form-control peso" placeholder="0">
                                        </div>
                                        
                                        <div class="col-md-4 form-group">
                                            <label>Valor Final da Obra</label><br>
                                            <input <?php if($edita != null){echo "value='". $edita['obra_valor_final'] ."'";} ?> id="valorfinal" name="valorfinal" type="text" class="form-control peso" placeholder="0">
                                        </div>
