                ...
                <div class="row main-row">
                    <div class="col-md-12 main-col-12">
                        ...
                        <div style="margin-bottom: 10px">
                            ...
                            <a data-toggle="modal" data-target="#modalCadastro" class="btn btn-primary" style="color: white">Novo Status/Situação</a>
                            <?php } ?>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <div class="row row-c">
                                <div class="col-md-10">
                                    <h4 class="modal-title" id="modalCadastroLabel">Cadastro de Tipo de Status/Situação</h4>
                                </div>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="nome_c" name="nome_c" placeholder="Ex.: Disponível, Em rota, Em reparo .." required>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <div class="row row-c">
                                <div class="col-md-10">
                                    <h4 class="modal-title" id="modalVerLabel">Visualizar Tipo de Status/Situação</h4>
                                </div>
                                <div class="col-md-2 text-right">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <div class="row row-c">
                                <div class="col-md-10">
                                    <h4 class="modal-title" id="modalEditarLabel">Edição de Tipo de Status/Situação</h4>
                                </div>
                                <div class="col-md-2 text-right">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                        ...
                        <form method="post" action="<?php echo base_url('frota/insertStatus') ?>">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-8 form-group">
                                        <label>Nome do Status</label><br>
                                        <input type="text" class="form-control" id="nome_e" name="nome_e" placeholder="Ex.: Disponível, Em rota, Em reparo ..." required>
                                    </div>
                                    <div class="col-md-4 form-group">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <div class="row row-c">
                                <div class="col-md-10">
                                    <h4 class="modal-title" id="modalCadastroLabel">Excluir Tipo de Status/Situação</h4>
                                </div>
                                <div class="col-md-2 text-right">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                            <h4>Deseja realmente excluir o tipo status/situação?</h4>
                        </div>
                        <div class="modal-footer">
                ...
                $(document).ready(function(){
                    ...
                    <?php 
                        if($erro == 1){
                            ...
                            echo "Swal.fire(
                            '',
                            'Não foi possivel excluir o status pois a senha inserida estava incorreta!',
                            'error'
                            )";
                        }
                        else if($erro == 3){
                            ...
                            echo "Swal.fire(
                            '',
                            'Não foi possivel reativar o status pois a senha inserida estava incorreta!',
                            'error'
                            )";
                        }
                    ?>
