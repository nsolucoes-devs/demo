                ...
                <div class="row main-row">
                    <div class="col-md-12 main-col-12">
                        ...
                        <div style="margin-bottom: 10px">
                            ...
                            <a data-toggle="modal" data-target="#modalCadastro" class="btn btn-primary" style="color: white">Novo Tipo de Cabine</a>
                            <?php } ?>
                        ...
                        <div class="tableFixHead">
                            <table id="myTableTipo" class="table table-hover table-bordered">
                                <thead>
                                    <tr>
                                        <th>Tipo de Cabine</th>
                                        <th style="width: 180px">Ação</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach($tiposgabine as $tipo){ ?>
    			                    <?php if($this->session->userdata('ativar') == 1){ ?>
                                    <tr <?php if($tipo['frota_tipogabine_ativo_id'] == 2){echo "style='color: #ff0000;'";} ?>>
                                        <td style="padding-top: 12px!important;"><?php echo ucwords(strtolower($tipo['frota_tipogabine_nome'])) ?></td>
                                        <?php if($tipo['frota_tipogabine_ativo_id'] != 2) { ?>
                                            <td style="text-align: center">
                                                <?php if($this->session->userdata('ver') == 1){ ?>
            			                        <a style="font-size: 12px" data-toggle="modal" data-target="#modalVer" onclick="ver(<?php echo $tipo['frota_tipogabine_id'] ?>)" class="btn btn-primary btn-modal-toggle"><i class="fas fa-eye"></i></a>
            			                        <?php } ?>
            			                        <?php if($this->session->userdata('editar') == 1){ ?>
            			                        <a data-toggle="modal" data-target="#modalEditar" onclick="editar(<?php echo $tipo['frota_tipogabine_id'] ?>)" class="btn btn-primary" style="font-size: 12px"><i class="fas fa-pencil-alt"></i></a>
            			                        <?php } ?>
            			                        <?php if($this->session->userdata('excluir') == 1){ ?>
            			                        <a data-toggle="modal" data-target="#modalExcluir" class="btn btn-danger" style="font-size: 12px" onclick="excluir('<?php echo $tipo['frota_tipogabine_id'] ?>')"><i class="fas fa-trash"></i></i></a>
            			                        <?php } ?>
                                            </td>
                                        <?php } else { ?>
                                            <td style="text-align: center">
                                                <a data-toggle="modal" data-target="#modalAtivar" class="btn btn-danger" style="font-size: 12px" onclick="setaAtivar('<?php echo $tipo['frota_tipogabine_id'] ?>')"><i class="fas fa-exclamation-triangle"></i></i></a>
                                            </td>
                                        <?php } ?>
                                    </tr>
                                    <?php }else if($tipo['frota_tipogabine_ativo_id'] != 2){ ?>
                                    <tr>
                                        <td style="padding-top: 12px!important;"><?php echo ucwords(strtolower($tipo['frota_tipogabine_nome'])) ?></td>
                                        <td style="text-align: center">
                                            <?php if($tipo['frota_tipogabine_ativo_id'] == 1){ if($this->session->userdata('ver') == 1){ ?>
        			                        <a style="font-size: 12px" data-toggle="modal" data-target="#modalVer" onclick="ver(<?php echo $tipo['frota_tipogabine_id'] ?>)" class="btn btn-primary btn-modal-toggle"><i class="fas fa-eye"></i></a>
        			                        &nbsp;&nbsp;
        			                        <?php } } ?>
        			                        <?php if($this->session->userdata('editar') == 1){ ?>
        			                        <a data-toggle="modal" data-target="#modalEditar" onclick="editar(<?php echo $tipo['frota_tipogabine_id'] ?>)" class="btn btn-primary" style="font-size: 12px"><i class="fas fa-pencil-alt"></i></a>
        			                        <?php } ?>
        			                        <?php if($tipo['frota_tipogabine_ativo_id'] == 1){ if($this->session->userdata('excluir') == 1){ ?>
        			                        &nbsp;&nbsp;
        			                        <a data-toggle="modal" data-target="#modalExcluir" class="btn btn-danger" style="font-size: 12px" onclick="excluir('<?php echo $tipo['frota_tipogabine_id'] ?>')"><i class="fas fa-trash"></i></i></a>
        			                        <?php } } ?>
                                        </td>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <h4>Deseja reativar o tipo cabine?</h4>
                        </div>
                        <div class="modal-footer" style="position: relative">
                            ...
                            <div class="row row-c" id="formsenha1" style="display: none">
                                <div class="col-md-12 text-center">
                                    <form action="<?php echo base_url('frota/ativarCabine') ?>" method="post">
                                        <input type="hidden" name="cabine_idatv" id="cabine_idatv">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <div class="row row-c">
                                <div class="col-md-10">
                                    <h4 class="modal-title" id="modalCadastroLabel">Cadastro de Tipo de Cabine</h4>
                                </div>
                        ...
                        <form method="post" action="<?php echo base_url('frota/insertTipoGabine') ?>">
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>Nome do Tipo de Cabine</label><br>
                                        <input type="text" class="form-control" id="nome_c" name="nome_c" placeholder="Ex.: Cabine Simples" required>
                                        <label for="suplementar">Suplementar?</label> <input type="checkbox" id="suplemento" name="suplemento" value="1">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <div class="row row-c">
                                <div class="col-md-10">
                                    <h4 class="modal-title" id="modalVerLabel">Visualizar Tipo de Cabine</h4>
                                </div>
                                <div class="col-md-2 text-right">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <div class="row row-c">
                                <div class="col-md-10">
                                    <h4 class="modal-title" id="modalEditarLabel">Edição de Tipo de Cabine</h4>
                                </div>
                                <div class="col-md-2 text-right">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                        ...
                        <form method="post" action="<?php echo base_url('frota/insertTipoGabine') ?>">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-8 form-group">
                                        <label>Nome do Tipo de Cabine</label><br>
                                        <input type="text" class="form-control" id="nome_e" name="nome_e" placeholder="Ex.: Cabine simples" required>
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label>Ativação</label>
                                        <select class="selecteditarcabine-filtro"  style="width: 100%!important" name="ativo_e" id="ativo_e" required>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <div class="row row-c">
                                <div class="col-md-10">
                                    <h4 class="modal-title" id="modalCadastroLabel">Excluir Tipo de Cabine</h4>
                                </div>
                                <div class="col-md-2 text-right">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                            <h4>Deseja realmente excluir o tipo de cabine?</h4>
                        </div>
                        <div class="modal-footer">
                            ...
                            <div class="row row-c" id="formsenha" style="display: none">
                                <div class="col-md-12 text-center">
                                    <form action="<?php echo base_url('frota/deleteTipoGabine') ?>" method="post">
                                        <input type="hidden" name="idtipogabine" id="idtipogabine">
                                        <label style="font-size: 16px">Confirme a senha</label><br>
            ...
            <script>
                $(document).ready(function(){
                    $('.selecteditarcabine-filtro').select2({theme: "bootstrap", dropdownParent: $('#modalEditar')});
                    $('#myTableTipo').DataTable( {
                        ...
                        "columns": [
                            {"Tipo de Cabine": "first", "orderable": true},
                    ...
                    <?php 
                        if($erro == 1){
                            ...
                            echo "Swal.fire(
                            '',
                            'Não foi possivel excluir a cabine pois a senha inserida estava incorreta!',
                            'error'
                            )";
                        }
                        else if($erro == 3){
                            ...
                            echo "Swal.fire(
                            '',
                            'Não foi possivel reativar a cabine pois a senha inserida estava incorreta!',
                            'error'
                            )";
                        }
                    ?>
            ...
            <script>
                function ver(id){
                    ...
                    var dados = {
                        'frota_tipogabine_id': id
                    };
                            
                    $.ajax({
                        url : '<?php echo base_url('frota/getTipoGabineById') ?>',
                        type : "POST",
                        dataType : "json",
                        data : dados,
                        success : function(response) {
                            res = response[0];
                            $("#nome_v").html(res.frota_tipogabine_nome);
                            
                            if(res.frota_tipogabine_ativo_id == 2){
                ...
                function editar(id){
                    ...
                    $.ajax({
                        ...
                        success : function(response) {
                            res = response[0];
                            $("#id_e").val(res.frota_tipogabine_id);
                            $("#nome_e").val(res.frota_tipogabine_nome);
                            $("#ativo_e").val(res.frota_tipogabine_ativo_id).change();
                        },
                        error : function(xhr, status, error) {
                            alert(status + " " + error + " " + xhr);
                        }
            ...
            <script>
                function excluir(id){
                    document.getElementById('idtipogabine').value = id;
                }
                function senha(){
                    document.getElementById('formsenha').style.display = "block";
                }
                function setaAtivar(id){
                    document.getElementById('cabine_idatv').value = id;
                }
                function senha1(){
