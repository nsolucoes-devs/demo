			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						if($despesa != null){
						    echo base_url('contas/editareDespesa');
						}else{
						    echo base_url('contas/novareDespesa');
						} 
						?>">
							...
							<div class="form-group">
							    <div class="row">
							        <div class="col-md-12" style="padding-top:10px">
        								...
        								<textarea type="text" class="form-control" required placeholder="Insira aqui a observação" id="obs" name="obs" rows="3"><?php if($despesa !=null){echo $despesa['observacao_despesa'];} ?></textarea>
    								</div>
								</div>
							</div>
							...
							<div class="form-group text-center" style="margin-top: 30px;">
							    ...
							    <a class="btn btn-primary" href="<?php if($this->session->userdata('tipo_pessoa') != 3){echo base_url('contas/telareDespesas/' . $caixaunico['id_caixa']);}
							    else{echo base_url('contas/telareDespesas');}?>">Voltar</a>
							</div>
						</form>
					</div>
				</div><!-- /.panel-->
