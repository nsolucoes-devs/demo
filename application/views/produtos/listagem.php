                ...
                <div class="row main-row">
                    <div class="col-md-12 main-col-12">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist" style="background-color: #eef5f9;">
                            <li class="nav-item">
                                <a href="<?php echo base_url('pecas') ?>" class="nav-link" style="background-color: white; cursor: pointer; font-size: 18px"><b>PEÇA</b></a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo base_url('produtos/listagemAbc') ?>" class="nav-link" style="background-color: #eee; cursor: pointer; font-size: 18px"><b>PEÇA ABC</b></a>
                            </li>
                        </ul>
                        
                        <div class="row white-tab" id="divPro" style="display: block;">
                            <div class="col-md-12" style="background-color:white; border-radius: 5px">
                        
                                <div style="padding-top: 1%;">
                                    <?php if($this->session->userdata('editar') == 1) { ?>
                                    <a href="<?php echo base_url('cadastrarpeca'); ?>" class="btn btn-primary" style='color: white'>Nova Peça</a>
                                ...
                                <div id="divfiltro" class="row" style="margin-left: calc(100% - 250px);">
                                    ...
                                    <form action="<?php echo base_url('pecas') ?>" method="post">
                                ...
                                <div class="tableFixHead">
                                    <table id="myTableProdutos" class="table table-hover table-bordered">
                                        ...
                                        <?php foreach($produtos as $produto){ ?>
                                            <?php if($this->session->userdata('ativar') == 1) { ?>
                                                <tr <?php if($produto['produto_ativo_id'] == 2){ echo "style='color: #ff0000;'"; }?>>
                                                    <td style="vertical-align: middle;">
                                                        <div class="encurtar" title="<?php echo ucwords(mb_strtolower($produto['produto_nome']));?>">
                                                            <?php echo ucwords(strtolower($produto['produto_nome'])) ?>
                                                        </div>
                                                    </td>
                                                    <td style="vertical-align: middle;">
                                                        <div class="encurtar" title="<?php echo ucwords(mb_strtolower($produto['produto_modelo']));?>">
                                                            <?php echo ucwords(strtolower($produto['produto_modelo'])) ?>
                                                        </div>
                                                    </td>
                                                    <td style="vertical-align: middle;">
                                                        <div class="encurtar" title="<?php echo ucwords(mb_strtolower($produto['produto_fabricante']));?>">
                                                            <?php echo ucwords(strtolower($produto['produto_fabricante'])) ?>
                                                        </div>
                                                    </td>
                                                    <?php if($produto['produto_ativo_id'] != 2) { ?>
                                                        <td style="text-align: center">
                                                            <?php if($this->session->userdata('ver') == 1){  ?>
                                                            <a style="font-size: 12px" class="btn btn-primary" href="<?php echo base_url('mostrarpeca/').$produto['produto_id'] ?>"><i class="fas fa-eye"></i></a>
                                                            <?php } ?>
                                                            <?php if($this->session->userdata('editar') == 1) { ?>
                                                            <a style="font-size: 12px" href="<?php echo base_url('editarpeca/').$produto['produto_id'] ?>" class="btn btn-primary" ><i class="fas fa-pencil-alt"></i></a>
                                                            <?php } ?>
                                                    ...
                                                    <?php } else { ?>
                                                        <td style="text-align: center">
                                                            <a data-toggle="modal" data-target="#modalAtivar" class="btn btn-danger" style="font-size: 12px" onclick="setaAtivar('<?php echo $produto['produto_id'] ?>')"><i class="fas fa-exclamation-triangle"></i></i></a>
                                                        </td>
                                                    <?php }  ?>
                                                </tr>
                                            <?php } ?>
