                                        ...
                                        <div id="conclusao">
                                            <div class="row">
                                                <div class="col-md-12 text-center form-group">
                                                    <h3><b>VISUALIZAÇÃO DE TÍTULO</b></h3>
                                                    <hr style="margin-top: 0">
                                                </div>
                                                
                                                <div class="col-md-3 form-group">
                                                    <label for="numser"><b>N° Doc:</b></label>
                                                    <input class="form-control" type="text" name="numser" id="numser" maxlength="26" value="<?php echo $titulo['titulos_numeroserie'] ?>" readonly>
                                                </div>
                                                <div class="col-md-3 form-group">
                                                    <label for="tipo"><b>Tipo:</b></label>
                                                    <select onchange="buscarEspecie()" style="width: 100%!important" class="select2" id="tipo" name="tipo" disabled>
                                                ...
                                                <div class="col-md-2 form-group">
                                                    ...
                                                    <input type="text" name="valor" id="valor" class="form-control" value="R$ <?php echo number_format($titulo['titulos_valor'], 4,',','.') ?>" readonly>
                                                </div>
                                                
                                                <div class="col-md-2 form-group">
                                                    <label><b>N° OS:</b></label>
                                                    <input type="text" name="numos" id="numos" class="form-control" value="<?php echo $titulo['titulos_numos'] ?>" readonly>
                                                </div>
                                                
                                                <div class="col-md-5 form-group">
                                                    <label for="fornecedor"><b>Tomador:</b></label>
                                                    <select style="width: 100%!important" class="select2" id="forneclin" name="forneclin" disabled required>
                                                ...
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    <textarea style="height: 100px" class="form-control" name="obs" id="obs" readonly><?php echo $titulo['titulos_observacao'] ?></textarea>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-12 form-group">
                                                    <div class="row" style="position: relative;top: calc(100% - 60px)!important;">
                                                        <div class="custom-control custom-switch text-left" style="left: 3%; top: 25px; width: 50%">
                                                            <input onchange="recorrenteChange()" type="checkbox" class="custom-control-input" id="switch1" name="recorrente" disabled <?php if($recorrente == 1) { echo 'checked'; } ?>>
                                                            <label class="custom-control-label" for="switch1"><?php if($recorrente == 1) { echo 'Este título é recorrente'; } else { echo 'Este título não é recorrente'; } ?></label>
