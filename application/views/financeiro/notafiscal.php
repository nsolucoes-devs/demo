            ...
            <div class="container-fluid">
                ...
                <div class="row main-row">
                    <div class="col-md-12 main-col-12" style="padding-right: 3%!important;">
                        ...
                        <div id="divfiltro" class="row" style="margin-left: calc(100% - 250px);">
                            ...
                            <form action="<?php echo base_url('financeiro/notasfiscais') ?>" method="post">
                        ...
                        <div class="tableFixHead">
                            <table id="myTableMovimentos" class="table table-hover table-bordered">
                                ...
                                <tbody>
        					        ...
        					        <tr>
        					            <td style="padding-top: 15px;"><?php echo $mv['emissao'] ?></td>
        					            <td style="vertical-align: middle;">
                                            <div class="encurtar" title="<?php echo ucwords(mb_strtolower($mv['numeroserie']));?>">
                                                <?php echo ucwords(strtolower($mv['numeroserie'])) ?>
                                            </div>
                                        </td>
                                        <td style="vertical-align: middle;">
                                            <div class="encurtar" title="<?php echo ucwords(mb_strtolower($mv['tipo']));?>">
                                                <?php echo ucwords(strtolower($mv['tipo'])) ?>
                                            </div>
                                        </td>
                                        <td style="vertical-align: middle;">
                                            <div class="encurtar" title="<?php echo ucwords(mb_strtolower($mv['cliente']));?>">
                                                <?php echo ucwords(strtolower($mv['cliente'])) ?>
                                            </div>
                                        </td>
                                        <td style="vertical-align: middle;">
                                            <div class="encurtar" title="<?php echo ucwords(mb_strtolower($mv['especie']));?>">
                                                <?php echo ucwords(strtolower($mv['especie'])) ?>
                                            </div>
                                        </td>
        					            <td style="padding-top: 15px;"><?php echo $mv['valor'] ?></td>
        					            <td style="text-align: center;">
        					                <?php if($this->session->userdata('ver') == 1 || $this->session->userdata('editar') == 1 || $this->session->userdata('excluir') == 1) { ?>
                                                <div class="btn-group dropleft">
                                                    <button type="button" class="btn btn-primary" style="border-radius: 4px" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><em class="fa fa-bars"></em></button>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <p style="position: absolute; left: 4%; color: #033557;"><b><?php echo $qtd_itens_pag ?> nota(s) fiscal(is) encontrada(s)</b></p>
                            ...
                            <div class="row row-c" id="formsenha" style="display: none">
                                <div class="col-md-12 text-center">
                                    <form action="<?php echo base_url('estoque/excluirNota') ?>" method="post">
                                        ...
                                        <input type="hidden" name="callback" id="callback" value="financeiro/notasfiscais">
                ...
                function pegaValor(id, pos){
                    ...
                    for(var i = 0; i < array.length; i++){
                        if(id == array[i].produto_id){
                            check = 1;
                            $('#vlr_'+newPos).unmask().val(array[i].produto_preco_custo).mask("#.##0,00", {reverse: true});
                        }
                    }
                    ...
                    if(check == 0){
                        ...
                        for(var i = 0; i < dp.length; i++){
                            var ex = dp[i].split('☺');
                            if(ex[0] == id){
                                $('#vlr_'+newPos).unmask().val(ex[1]).mask("#.##0,00", {reverse: true});
                            }
                        }
                    }
                }
                ...
                function pegaValorServ(id, pos){
                    ...
                    for(var i = 0; i < array.length; i++){
                        if(id == array[i].servico_id){
                            check = 1;
                            $('#vlrServ_'+newPos).unmask().val(array[i].servico_custo).mask("#.##0,00", {reverse: true});
                        }
                    }
                    ...
                    if(check == 0){
                        ...
                        for(var i = 0; i < ds.length; i++){
                            var ex = ds[i].split('☺');
                            if(ex[0] == id){
                                $('#vlrServ_'+newPos).unmask().val(ex[1]).mask("#.##0,00", {reverse: true});
                            }
                        }
                    }
                }
